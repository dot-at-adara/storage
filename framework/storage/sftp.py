...
def download_remote_file(ssh: paramiko.client, remote_file_path: str, local_dir_path: str = None,
    ...
    :return:
    """
    from framework.storage import UPLOAD_FOLDER
    from logging import getLogger
    import os
    logger = getLogger()
    try:
